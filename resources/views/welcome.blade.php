    ...
    <center>
        ...
        <h2 class="subt">Não perca a data de nenhum evento <br> veja horarios, locais, descrição valores e muito mais.</h2>
        <br> <br>
        ...
        <footer class="footer mt-auto py-3 text-white fixed-bottom">
            <div class="container text-center">
                ...
                <a href="https://github.com/DaviJoseMach" target="_blank">
